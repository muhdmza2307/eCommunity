...
<cffunction name="SVCSvrFileDSUpdate" description="Updating DS with latest server file depending on APPLOCID and if file exists or not" access="public" returntype="boolean" output="false">
	<cfargument name="LOGICNAME" required="false" type="string" default="" displayname="Individual logicname to refresh" hint="">
	<CFQUERY NAME=Local.q_svrfiles DATASOURCE=#Request.MTRDSN#>
		SELECT a.vaSVRFILELOGICNAME,a.vaSVRFILENAME,a.vaSVRFILEEXT, a.vaSVRFILETYPE, a.iSVRFILEVERSION,a.vaSVRFILETYPE
			,a.vaSVRFILELOGPATH
			...
			order by a.vaSVRFILELOGICNAME
	</CFQUERY>
	<CFSET Local.SVRFILES=StructNew()>
	<CFSET Local.LAST_REFKEY="">
	<CFLOOP query=Local.q_svrfiles>
		<CFSET Local.REFKEY="MIC_#UCASE(Trim(vaSVRFILELOGICNAME))#">
		<CFIF Local.REFKEY IS NOT Local.LAST_REFKEY>
			...
			<CFIF iSVRFILEVERSION GT 0>
				...
				<CFSET Local.FILEPATH=Local.Path & Trim(vaSVRFILENAME) & versionstr & "." & Trim(vaSVRFILEEXT)>
	...
	<CFIF arguments.LOGICNAME neq "" AND Local.q_svrfiles.RecordCount GT 0><!--- Just update the DS with this new item. --->
...
<cfargument name="grp" required="false">
<cfargument name="logic" required="false">
...
<!--- <cfinvoke component="#Request.APPPATHCFC#eCommunity.CustomTags.ECaddfile" method="SVCSvrFileDSUpdate" LOGICNAME=#arguments.logic#> --->
...
<CFSET Local.webrootpath = Evaluate(DE(Request.DS.SVRFILES[Local.refkey].LOGPATH))>

<CFSET Local.SVRFILE.PATH=Local.webrootpath & Request.DS.SVRFILES[Local.refkey].FILENAME & Local.latestversion_no & "." & Request.DS.SVRFILES[Local.refkey].EXT>
...
<cfset request.SVRFILE = Local.SVRFILE>
