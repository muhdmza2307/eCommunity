...
<body>
   ...
   <cfquery name="roleList" datasource="#request.MTRDSN#">
    ...
    <cfoutput>
      <cfmodule TEMPLATE="#request.LOGPATH#/CustomTags/ECADDFILE.cfm" Fname="GIJGO_DATEPICKER_JS">
      <cfmodule TEMPLATE="#request.LOGPATH#/CustomTags/ECADDFILE.cfm" Fname="GIJGO_DATEPICKER_CSS">
    </cfoutput>
